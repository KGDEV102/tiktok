        ...
        <header className={cx("wrapper")}>
            <div className={cx("inner")}>
                ...
                <div className={cx("action")}>
                    {currentUser ? (
                    <>
                       <Tippy content="Upload video" placement="bottom"  delay={[0,700]}  >
                         ...
                         <Tippy content="Message" placement="bottom"   delay={[0,700]}  >
                            <button className={cx("action-btn")}>
                                 <MessageIcon />
                                </button>
                        </Tippy>
                        <Tippy content="Notifications" placement="bottom"   delay={[0,700]}  >
                            <button className={cx("action-btn",)}>
                                <InboxIcon />
